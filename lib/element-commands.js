...
_.each(utils.elementFuncTypes, function(type) {
   ...
   * @docOrder 8
   */
  elementCommands['hasElement' + utils.elFuncSuffix(type)] = function() {
    var args = Array.prototype.slice.call(arguments, 0);
    args.unshift(utils.elFuncFullType(type));
    elementCommands.hasElement.apply(this, args);
  };

  /**
   * element.waitForElementByClassName(value, cb) -> cb(err, element)
   * element.waitForElementByCssSelector(value, cb) -> cb(err, element)
   * element.waitForElementById(value, cb) -> cb(err, element)
   * element.waitForElementByName(value, cb) -> cb(err, element)
   * element.waitForElementByLinkText(value, cb) -> cb(err, element)
   * element.waitForElementByPartialLinkText(value, cb) -> cb(err, element)
   * element.waitForElementByTagName(value, cb) -> cb(err, element)
   * element.waitForElementByXPath(value, cb) -> cb(err, element)
   * element.waitForElementByCss(value, cb) -> cb(err, element)
   * element.waitForElementByIosUIAutomation(value, cb) -> cb(err, element)
   * element.waitForElementByAndroidUIAutomator(value, cb) -> cb(err, element)
   * element.waitForElementByAccessibilityId(value, cb) -> cb(err, element)
   * asserter, timeout, pollFreq are optional, opts may be passed instead,
   * as in waitForElement.
   */
  elementCommands['waitForElement' + utils.elFuncSuffix(type)] = function() {
    var args = Array.prototype.slice.call(arguments, 0);
    args.unshift(utils.elFuncFullType(type));
    elementCommands.waitForElement.apply(this, args);
  };
  ...
  elementCommands['elements' + utils.elFuncSuffix(type)] = function(value, cb) {
    ...
    /**
   * element.waitForElementsByClassName(value, cb) -> cb(err, element)
   * element.waitForElementsByCssSelector(value, cb) -> cb(err, element)
   * element.waitForElementsById(value, cb) -> cb(err, element)
   * element.waitForElementsByName(value, cb) -> cb(err, element)
   * element.waitForElementsByLinkText(value, cb) -> cb(err, element)
   * element.waitForElementsByPartialLinkText(value, cb) -> cb(err, element)
   * element.waitForElementsByTagName(value, cb) -> cb(err, element)
   * element.waitForElementsByXPath(value, cb) -> cb(err, element)
   * element.waitForElementsByCss(value, cb) -> cb(err, element)
   * element.waitForElementsByIosUIAutomation(value, cb) -> cb(err, element)
   * element.waitForElementsByAndroidUIAutomator(value, cb) -> cb(err, element)
   * element.waitForElementsByAccessibilityId(value, cb) -> cb(err, element)
   * asserter, timeout, pollFreq are optional, opts may be passed instead,
   * as in waitForElements.
   */
  elementCommands['waitForElements' + utils.elFuncSuffix(type)] = function() {
    var args = Array.prototype.slice.call(arguments, 0);
    args.unshift(utils.elFuncFullType(type));
    elementCommands.waitForElements.apply(this, args);
  };
});
 ...
 * @docOrder 7
 */
elementCommands.hasElement = function(using, value){
  var cb = utils.findCallback(arguments);
  elementCommands.elements.apply( this, [using, value, function(err, elements){
    if(!err) {
 ...
 */
elementCommands.waitForElement = commands.waitForElement
 ...
 * asserter like: function(element , cb) -> cb(err, satisfied, el)
 */
elementCommands.waitForElements = commands.waitForElements
